...
\section{SYSTEM ANALYSIS}\label{sec:system_analysis}
  ...
  This section presents the overall scope and system requirements, along with a detailed analysis of the modules and features assigned to me.
  % 2.1 Scope
  \subsection{Scope}
  \label{sec:scope}
  \input{section/II_objective/scope.tex}

  % 2.2 System Requirements
  \subsection{System Requirements}
  \input{section/II_objective/desired_feature.tex}

  % 2.3 Non-functional Requirements
  \subsection{Non-functional Requirements}
  \input{section/II_objective/non_functional_requirements.tex}

  % 2.4 Use case diagram
  % \subsection{Use-case Diagram}
  % \input{section/II_objective/use_case_diagram.tex}

  % 2.5 Use-case specification
  \subsection{Use case Specification}\label{sec:use_case_specification}
  \input{section/II_objective/use_case_specification.tex}

  % 2.6 Sequence diagram
  \newpage
  \subsection{Sequence diagram}
  \input{section/II_objective/sequence_diagram.tex}

  % % 2.7 Database design
  % \subsection{Database Design}
  % \input{section/II_objective/database_design.tex}
...
\section{SYSTEM DESIGN}\label{sec:system_design}
  ...
  \input{section/III_system_design/system_architecture_overview.tex}

    % 3.2 Software block diagram
  \subsection{Software Block Diagram}
  \input{section/III_system_design/software_block_diagram.tex}
...
\section{METHODOLOGY}\label{sec:methodology}
  ...
  \input{section/IV_methodology/technology.tex}
...
\section{TESTING}\label{sec:testing}
  ...
  % 4.1
  % \subsection{Technologies}
  \input{section/V_testing/testing.tex}
...
\section{RESULTS AND DISCUSSIONS}\label{sec:results_and_discussion}
  ...
  % 5.1 Results
  \subsection{Results}
  \input{section/V_results_discussions/result.tex}

  % 5.2 Results
  % \subsection{Contributions}
  % \input{section/V_results_discussions/contributions.tex}

  % 5.2 Discussions
  \subsection{Discussions}
  \input{section/V_results_discussions/discussions.tex}
...
\indent
  ...
  \input{section/VI_conclusion_future_scope/conclusion.tex}

  % 6.2 Discussions
  \subsection{Future Work}
  \input{section/VI_conclusion_future_scope/future_scope.tex}
